...
DATA_STORAGE_DIR = Path(os.environ.get("DATA_DIR", WORKING_DIR))
...
def _resource_path(relative_path: Path | str) -> Path:
    ...
    """
    p = DATA_STORAGE_DIR.joinpath(relative_path)
    try:
...
# Other Paths
DATA_STORAGE_DIR = Path(os.environ.get("DATA_DIR", WORKING_DIR))
LOG_PATH = Path(DATA_STORAGE_DIR, "log.txt")
DUMP_PATH = Path(DATA_STORAGE_DIR, "dump.dat")
LOCK_PATH = Path(DATA_STORAGE_DIR, "lock.file")
CACHE_PATH = Path(DATA_STORAGE_DIR, "cache")
CACHE_DB = Path(CACHE_PATH, "mapping.json")
COOKIES_PATH = Path(DATA_STORAGE_DIR, "cookies.jar")
SETTINGS_PATH = Path(DATA_STORAGE_DIR, "settings.json")
# Typing
